<template lang="pug">
  section.section.terms
    v-layout
      v-container.white
        h1.pb-2.headline.font-weight-bold 利用規約
        p この利用規約（以下，「本規約」といいます。）は，osao3's accessory（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        ...
        ol
          li ユーザーは，自己の責任において，本サービスのメールアドレスおよびユーザーID、およびパスワードを適切に管理するものとします。
          li ユーザーは，いかなる場合にも，メールアドレスおよびユーザーID、およびパスワードを第三者に譲渡または貸与し，もしくは第三者と共用することはできません。当社は，メールアドレス（ユーザーID）とパスワードの組み合わせが登録情報と一致してログインされた場合には，そのメールアドレス（ユーザーID）を登録しているユーザー自身による利用とみなします。
          li メールアドレスおよびユーザーID、およびパスワードが第三者によって使用されたことによって生じた損害は，当社に故意又は重大な過失がある場合を除き，当社は一切の責任を負わないものとします。
        ...
        ol
          ...
          li 本サービスに関して紛争が生じた場合には，横浜簡易裁判所または横浜地方裁判所を専属的合意管轄とします。
